...
export default function Shop() {
  ...
  const maxProductPrice = products.length
    ? Math.ceil(Math.max(...products.map((p) => Number(p.Unit_Price))))
    : 100;
        ...
        <div className="container">
          ...
          >
            ...
            {activeCat !== "All" && (
              <>
                {" "}
                › <strong style={{ color: "#16a34a" }}>{activeCat}</strong>
              </>
            )}
          </span>
        </div>
          ...
          >
            ...
            <div style={{ marginBottom: 22 }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{ paddingRight: searchInput ? 36 : 14 }}
                />
                {searchInput && (
                  <button
            ...
            <div style={{ marginBottom: 22 }}>
              ...
              >
                {catNames.map((c) => (
                  <button
                    key={c}
                    className={`sp-cat-btn${activeCat === c ? " active" : ""}`}
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: 11,
                        color: activeCat === c ? "#16a34a" : "#9ca3af",
                        fontWeight: 600,
                      }}
                    >
                      {c === "All"
                        ? products.length
                        : products.filter((p) => p.Category_Name === c).length}
                    </span>
                  </button>
                ))}
              </div>
            ...
            <div style={{ marginBottom: 22 }}>
              ...
              >
                Price Range
                <span
                  style={{ float: "right", color: "#16a34a", fontWeight: 800 }}
                >
                  ${maxPrice}
                </span>
              </label>
          ...
          <div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <button
                  className={`sp-view-btn${view === "list" ? " active" : ""}`}
