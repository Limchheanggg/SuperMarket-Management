...
const info = [
  { icon: '📍', title: 'Our Store',     value: 'Russian Blvd, Phnom Penh', sub: 'Cambodia' },
  { icon: '📞', title: 'Call Us',       value: '+855 12 345 678',            sub: 'Mon–Sun, 7AM–9PM' },
  { icon: '✉️', title: 'Email Us',      value: 'limchheang@amsmart.kh',           sub: 'We reply within 24h' },
  { icon: '🕐', title: 'Store Hours',   value: 'Mon–Sun',                    sub: '7:00 AM – 9:00 PM' },
]
